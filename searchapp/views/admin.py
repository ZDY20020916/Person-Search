...
from searchapp.utils.form import AdminModelForm, AdminEditModelForm, AdminResetModelForm, UserModelForm, UserEditModelForm
...
def admin_list(request):
    ...
    # 页码组件类
    page_object = Pagination(request, admin_list, page_size=10)  # 每页最多显示2个数据
